...
if( length(grep(".gz",matrix_file)) > 0 ){
  corr.matrix<-abs(read.table(gzfile(matrix_file)))
  }     else{
  corr.matrix<-abs(read.table(matrix_file))}
print("finished reading the matrix")
print(Sys.time())

evals<-eigen(t(corr.matrix),symmetric=T)$values
rm(corr.matrix)
print("finished calculating eigenvalues")
print(Sys.time())
...
print("finished calculating the old method")
print(Sys.time())
##############################################################################################################################################
...
print("finished calculating the new method")
print(Sys.time())
##############################################################################################################################################
